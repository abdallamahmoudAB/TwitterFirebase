...
class MainTabController: UITabBarController {
    ...
    func configureViewControllers() {
        ...
        let nav3 = templateNavController(image: UIImage(named: "like_unselected"), rootViewController: notification)
        
        let conversation = ConversationController()
        let nav4 = templateNavController(image: UIImage(named: "mail"), rootViewController: conversation)
