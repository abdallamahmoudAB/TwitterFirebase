...
//  TwitterClone
//
//  Created by benji on 01/01/2022.
//
...
class TweetController: UICollectionViewController {
    ...
    func configureCollectionView() {
        ...
        collectionView.register(TweetHeader.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: headerID)
    }
